...
export function Navbar() {
  ...
  const [userProgress, setUserProgress] = useState<UserStats | null>(null)
  ...
  const progressPercent = userProgress ? (userProgress.total_xp / userProgress.next_level_xp) * 100 : 0
            ...
            <div className="hidden lg:flex items-center gap-3">
              <div className="text-right">
                ...
                <div className="text-xs text-gray-500">
                  {userProgress.total_xp} / {userProgress.next_level_xp} XP
                </div>
              </div>
              <div className="w-32">
                <ProgressBar
